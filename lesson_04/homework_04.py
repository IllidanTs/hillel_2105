adwentures_of_tom_sawer = """
    ...
    "a kite, in good repair; and when he played out, Johnny Miller bought in for a dead rat "
    "and a string to swing it with—and so on, and so on, hour after hour. "
    "And when the middle of the afternoon came, from being a poor poverty, stricken boy "
